...
function runBrow() {
  if(document.body.querySelector('.browserInfo')) return;
...
//The order matters here, and this may report false positives for unlisted browsers.
  ...
  // hr.style.marginTop = 22 + 'px';
  out.append(hr);

  let div = document.createElement('div');
  div.className = 'browserInfo';
  div.innerHTML =
    `<span style="background: #FFA07A">You are using: <strong>${sBrowser}</strong> and OS: <strong>${sUsrOs}</strong></span>`;
